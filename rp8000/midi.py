...
class SysEx:
	...
	def __init__(self, model, channel=1):
		...
		if self.model == "RP8000mk2": self.startup(channel)
	...
	def shutdown(self):
		...
		and puts the turntable back into pitch display mode - Only disables one channel at a time
		"""
		self.send_message([
